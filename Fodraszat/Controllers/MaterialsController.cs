...
namespace Fodraszat.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ItemNumber,MaterialName,Price,Cost,BoxPrice")] Materials materials)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ItemNumber,MaterialName,Price,Cost,BoxPrice")] Materials materials)
        {
            if (ModelState.IsValid)
            {
